...
const ResponsiveAppBar = () => {
    ...
    /// Todo lo comentado aquí es para ocultar la experiencia laboral. 

    const theme = useTheme()
    // const { page, setPage } = useConfigAppContext()
    // La siguiente variable necesita añadir la props 'w'.
    ...
    // HandleClose para el botón de cambiar Experiencia por portafolio
